...
ALTER TABLE public.info ADD CONSTRAINT info_id_not_null NOT NULL id;
ALTER TABLE public.info ADD CONSTRAINT info_name_not_null NOT NULL name;
...
ALTER TABLE public.owner ADD CONSTRAINT owner_code_not_null NOT NULL code;
ALTER TABLE public.owner ADD CONSTRAINT owner_first_name_not_null NOT NULL first_name;
ALTER TABLE public.owner ADD CONSTRAINT owner_id_not_null NOT NULL id;
ALTER TABLE public.owner ADD CONSTRAINT owner_last_name_not_null NOT NULL last_name;
...
ALTER TABLE public.pet ADD CONSTRAINT pet_id_not_null NOT NULL id;
ALTER TABLE public.pet ADD CONSTRAINT pet_info_id_not_null NOT NULL info_id;
ALTER TABLE public.pet ADD CONSTRAINT pet_owner_id_not_null NOT NULL owner_id;
ALTER TABLE public.pet ADD CONSTRAINT pet_pkey PRIMARY KEY (id);
ALTER TABLE public.pet ADD CONSTRAINT pet_type_not_null NOT NULL type;
